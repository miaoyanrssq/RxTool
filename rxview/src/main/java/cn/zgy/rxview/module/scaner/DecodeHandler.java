package cn.zgy.rxview.module.scaner;
...
import cn.zgy.rxview.activity.ActivityScanerCode;
	...
	/*private void decode(byte[] data, int width, int height) {
		...
		if (result != null) {
			if(null != activity.getHandler()){
				...
				msg.obj = "二维码:"+result;
				msg.what = cn.zgy.rxview.R.id.decode_succeeded;
			...
			if(result_line != null){
				...
				if (null != activity.getHandler()) {
					activity.getHandler().sendEmptyMessage(cn.zgy.rxview.R.id.decode_failed);
				}
			}
