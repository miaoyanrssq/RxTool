...
import cn.zgy.rxtool.RxImageTool;
import cn.zgy.rxtool.RxPermissionsTool;
import cn.zgy.rxtool.RxRecyclerViewDividerTool;
import cn.zgy.rxtools.adapter.AdapterRecyclerViewMain;
import cn.zgy.rxtools.model.ModelMainItem;
import cn.zgy.rxview.activity.ActivityCodeTool;
import cn.zgy.rxview.activity.ActivityWebView;
...
public class ActivityMain extends AppCompatActivity {
    ...
    private void initData() {
        ...
        mData.add(new ModelMainItem("其他", R.mipmap.ic_launcher, OtherActivity.class));
    }
