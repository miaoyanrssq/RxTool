package cn.zgy.rxtools.token;

import android.text.TextUtils;


import cn.zgy.rxtools.ApplicationRxTools;
import cn.zgy.rxtools.constant.AuthModel;
import cn.zgy.rxtools.constant.ComParamContact;
import cn.zgy.rxtools.tools.ACache;
...
public class TokenManager {
    ...
    public TokenManager() {
        aCache = ACache.get(ApplicationRxTools.getAppContext(), key);
